...
export default function ParkingsIdLayout({
  ...
  const getButtonVariant = (url: string) =>
    currentUrl === url ? "filled" : "transparent";
  ...
  return (
    <>
      <LoadingOverlay
        visible={isDeleting}
        zIndex={10000000}
        overlayProps={{ color: "var(--mantine-color-dark)" }}
      />
      <AppShell
        header={{ height: 60 }}
        navbar={{
                ...
                modals.openConfirmModal({
                  ...
                  children: (
                    <Alert title={"Cette action est irréversible"}>
                      Vous êtes sur le point de supprimer le parking{" "}
                      {parking?.name} ainsi que toutes les ressources associées.
                  ...
                  onConfirm: async () => {
                    ...
                    try {
                      ...
                      notifications.show({
                        ...
                        message:
                          "Une erreur est survenue lors de la suppression du parking. Veuillez réessayer.",
                      });
                    }
                  },
                });
